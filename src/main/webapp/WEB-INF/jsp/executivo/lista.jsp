...
<body>
	...
	<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
		<div
			...
			<div>
				<h1 class="h2">Executivos: ${fn:length(executivos)}</h1>
			</div>
			<div>
				<a class="btn btn-sm btn-outline-secondary" href="/executivo">Novo</a>
			</div>
		</div>	
				    ...
				    <tbody>	
				    	<c:forEach var="ex" items="${executivos}">
					      ...
					      <tr>
					        ...
					        <td>${ex.modelo}</td>
					        <td>${ex.placa}</td>
					        <td><fmt:formatNumber value="${ex.valor}" minFractionDigits="2" type="currency" /></td>
					      	<td class="actions">
	<!-- 							        	<a class="btn btn-success btn-xs" href="view.html">Visualizar</a> -->
								<a class="btn btn-warning btn-xs" href="/executivo/${ex.id}/alterar">Editar</a>		                    
					            <a class="btn btn-danger btn-xs" href="/executivo/${ex.id}/excluir">Excluir</a>
					        </td>
					      </tr>
				      </c:forEach>
				    </tbody>
