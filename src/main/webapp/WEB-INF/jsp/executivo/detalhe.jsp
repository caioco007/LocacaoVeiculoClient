...
<body>
	...
	<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
		<div
			...
			<div>
				<h1 class="h2">Cadastro de Veiculo Executivo ${operacao}</h1>
			</div>
			<div>
				<p class="help-block">
					<h11>*</h11>
		...
		<div class="container">
		   ...
		   <div class="row">
				...
				<div class="form-check">
				 	<input class="form-check-input" type="checkbox" name="automatico" value="true" id="defaultCheck1" checked> 
					<label class="form-check-label" for="defaultCheck1"> Carro Automático </label>
			   </div>				
		</div>
