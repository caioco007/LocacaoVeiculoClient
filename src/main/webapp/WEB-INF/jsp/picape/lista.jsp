...
<body>
	...
	<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
		<div
			...
			<div>
				<h1 class="h2">Picapes: ${fn:length(picapes)}</h1>
			</div>
			<div>
				<a class="btn btn-sm btn-outline-secondary" href="/picape">Novo</a>
			</div>
		</div>	
	...
	<!-- 							        	<a class="btn btn-success btn-xs" href="view.html">Visualizar</a> -->
								<a class="btn btn-warning btn-xs" href="/picape/${p.id}/alterar">Editar</a>		                    
					            <a class="btn btn-danger btn-xs" href="/picape/${p.id}/excluir">Excluir</a>
					        </td>
					      </tr>
				      </c:forEach>
				    </tbody>
